...
_DATA_DIR = "data"
_SENTINEL = os.path.join(_DATA_DIR, "orders.csv")

# These tests validate the mock/fuzzy-factory dataset schema.
# They are skipped automatically when that dataset is not active.
# To activate it: python switch_dataset.py mock
@unittest.skipUnless(
    os.path.exists(_SENTINEL),
    "Mock dataset not active — run: python switch_dataset.py mock",
)
