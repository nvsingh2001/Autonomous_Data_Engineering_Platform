...
class TestDataGeneration(unittest.TestCase):
    ...
    def test_orders_headers(self):
        df = pd.read_csv(os.path.join(self.data_dir, "orders.csv"), nrows=1)
