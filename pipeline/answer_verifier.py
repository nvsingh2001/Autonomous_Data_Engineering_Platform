...
_PROMPT = (
    ...
    "says 'minus refunds', subtract refunds. If the metric splits into groups (e.g. new vs "
    "returning), return one row per group with a clear text label column and the numeric value. "
    "Output ONLY the SQL.\n\n"
    "WAREHOUSE SCHEMA:\n{schema}\n\n"
